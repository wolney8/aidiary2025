...
FOREIGN_KEY_CHECKS = [
    ...
    ("billing_customers", "user_id", "users", "id"),
    ("subscriptions", "user_id", "users", "id"),
    ("entitlements", "user_id", "users", "id"),
    ("billing_events", "user_id", "users", "id"),
    ("usage_events", "user_id", "users", "id"),
    ("admin_announcements", "created_by", "users", "id"),
    ("admin_announcement_targets", "announcement_id", "admin_announcements", "id"),
    ("admin_announcement_user_state", "announcement_id", "admin_announcements", "id"),
    ("admin_announcement_user_state", "user_id", "users", "id"),
    ("admin_audit_events", "actor_user_id", "users", "id"),
    ("admin_audit_events", "target_user_id", "users", "id"),
